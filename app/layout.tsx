...
export const metadata: Metadata = {
  title:
    "ТСК Горизонт — каркасные дома в Нижнекамске и Набережных Челнах",
  description:
    "Каркасные дома под ключ от 2,1 млн ₽. Срок от 45 дней, гарантия 5 лет. Нижнекамск и Набережные Челны.",
};
